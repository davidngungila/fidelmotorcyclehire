...
<head>
    ...
    <title>419 Page Expired - Member Portal</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
            <!-- Header -->
            <div class="bg-gradient-to-br from-teal-500 to-cyan-600 p-8 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="w-24 h-24 mx-auto mb-4 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                        <i class="fa-solid fa-hourglass-end text-5xl text-white"></i>
                    </div>
                    <h1 class="text-6xl font-black text-white mb-2">419</h1>
                    <p class="text-xl font-semibold text-white/90">Page Expired</p>
                </div>
            </div>
            ...
            <div class="p-8 md:p-10">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Session Timeout</h2>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 mb-6">
                    ...
                    <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-clock text-teal-500 mt-0.5"></i>
                            <span>Your session has timed out due to inactivity</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-shield-check text-teal-500 mt-0.5"></i>
                            <span>This is a security feature to protect your account</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-key text-teal-500 mt-0.5"></i>
                            <span>The security token for this page has expired and needs to be refreshed</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 mb-8">
                    ...
                    <ul class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Log in again to start a new session</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>Reload the page to get a fresh security token</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>Try resubmitting your form if you were in the middle of an action</span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 px-8 py-4 text-center border-t border-gray-100 dark:border-gray-700">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    Error Code: 419 • Timestamp: {{ now()->format('Y-m-d H:i:s') }} • 
