...
<head>
    ...
    <title>401 Unauthorized - Member Portal</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
            <!-- Header -->
            <div class="bg-gradient-to-br from-yellow-500 to-amber-600 p-8 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="text-6xl font-black text-white mb-2">401</h1>
                    <p class="text-xl font-semibold text-white/90">Unauthorized</p>
                </div>
            </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 mb-6">
                    ...
                    <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-user-xmark text-yellow-500 mt-0.5"></i>
                            <span>You are not currently logged into the system</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-clock-rotate-left text-yellow-500 mt-0.5"></i>
                            <span>Your session may have expired due to inactivity</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-id-card text-yellow-500 mt-0.5"></i>
                            <span>Valid authentication credentials are required to access this page</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 mb-8">
                    ...
                    <ul class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Log in with your registered account credentials</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>If you forgot your password, use the <a href="{{ route('password.request') }}" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">forgot password</a> link</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>Contact support if you're having trouble accessing your account</span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 px-8 py-4 text-center border-t border-gray-100 dark:border-gray-700">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    Error Code: 401 • Timestamp: {{ now()->format('Y-m-d H:i:s') }} • 
