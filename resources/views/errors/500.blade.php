...
<head>
    ...
    <title>500 Server Error - Member Portal</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
            <!-- Header -->
            <div class="bg-gradient-to-br from-purple-500 to-indigo-600 p-8 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="w-24 h-24 mx-auto mb-4 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                        <i class="fa-solid fa-server text-5xl text-white"></i>
                    </div>
                    <h1 class="text-6xl font-black text-white mb-2">500</h1>
                    <p class="text-xl font-semibold text-white/90">Internal Server Error</p>
                </div>
            </div>
            ...
            <div class="p-8 md:p-10">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Something Went Wrong</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Our servers encountered an unexpected error while processing your request. This is not your fault - it's an issue on our end.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 mb-6">
                    ...
                    <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-bug text-purple-500 mt-0.5"></i>
                            <span>An unexpected error occurred on the server while processing your request</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-database text-purple-500 mt-0.5"></i>
                            <span>There might be a temporary issue with our database or external services</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-triangle-exclamation text-purple-500 mt-0.5"></i>
                            <span>The system administrators have been notified and are working on a fix</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 mb-8">
                    ...
                    <ul class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Refresh the page and try your request again</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>Wait a few minutes and try again - the issue might be temporary</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>Contact support if the problem persists: <a href="mailto:support@example.com" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">support@example.com</a></span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 px-8 py-4 text-center border-t border-gray-100 dark:border-gray-700">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    Error Code: 500 • Timestamp: {{ now()->format('Y-m-d H:i:s') }} • 
