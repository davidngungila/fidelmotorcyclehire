...
<head>
    ...
    <title>404 Not Found - Member Portal</title>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-br from-amber-500 to-orange-600 p-8 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xl font-semibold text-white/90">Page Not Found</p>
                </div>
            </div>
            ...
            <div class="p-8 md:p-10">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Lost in Space</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        The page you're looking for doesn't exist or has been moved. It might have been deleted, renamed, or is temporarily unavailable.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 mb-6">
                    ...
                    <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-link-slash text-amber-500 mt-0.5"></i>
                            <span>The URL you entered may be incorrect or the link is broken</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-trash-can text-amber-500 mt-0.5"></i>
                            <span>The page may have been removed or relocated by the administrator</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-clock text-amber-500 mt-0.5"></i>
                            <span>The resource might be temporarily unavailable due to maintenance</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 mb-8">
                    ...
                    <ul class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Double-check the URL for typos and try again</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                        ...
                        <li class="flex items-start gap-3">
                            <i class="fa-solid fa-check-circle text-blue-500 mt-0.5"></i>
                            <span>Return to the <a href="{{ url('/') }}" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">dashboard</a> and start fresh</span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 px-8 py-4 text-center border-t border-gray-100 dark:border-gray-700">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    Error Code: 404 • Timestamp: {{ now()->format('Y-m-d H:i:s') }} • 
