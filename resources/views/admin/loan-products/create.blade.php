...
@section('page_title', 'Create Loan Product')

@section('breadcrumb', 'Loan Products › Create')
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
          ...
          <textarea name="description" rows="3"
                    ...
                    class="form-input py-2.5 px-4">{{ old('description') }}</textarea>
          @error('description')
            <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div>
          ...
          <input type="number" name="min_amount" value="{{ old('min_amount') }}" required min="0" step="0.01"
        ...
        <div>
          ...
          <input type="number" name="max_amount" value="{{ old('max_amount') }}" required min="0" step="0.01"
        ...
        <div>
          ...
          <input type="number" name="min_term_months" value="{{ old('min_term_months') }}" required min="1"
                 placeholder="e.g., 3"
                 class="form-input py-2.5 px-4">
        ...
        <div>
          ...
          <input type="number" name="max_term_months" value="{{ old('max_term_months') }}" required min="1"
                 placeholder="e.g., 36"
                 class="form-input py-2.5 px-4">
        ...
        <div>
          ...
          <select name="repayment_frequency" required class="form-input py-2.5 px-4">
            ...
            <option value="bi_weekly" {{ old('repayment_frequency') === 'bi_weekly' ? 'selected' : '' }}>Bi-Weekly</option>
          </select>
        ...
        <div>
          ...
          <input type="number" name="processing_fee" value="{{ old('processing_fee') }}" required min="0" step="0.01"
        ...
        <div>
          ...
          <input type="number" name="late_fee" value="{{ old('late_fee') }}" required min="0" step="0.01"
        ...
        <div>
          ...
          <div class="space-y-2 mt-2">
            <label class="flex items-center gap-2">
              <input type="checkbox" name="requires_collateral" value="1" {{ old('requires_collateral') ? 'checked' : '' }} class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
              <span class="text-sm text-gray-700 dark:text-gray-300">Requires Collateral</span>
            </label>
            <label class="flex items-center gap-2">
              <input type="checkbox" name="requires_guarantor" value="1" {{ old('requires_guarantor') ? 'checked' : '' }} class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
