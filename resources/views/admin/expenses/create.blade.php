...
@section('breadcrumb', 'Accounting \u203A Expenses \u203A Create Expense')
...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Expense</h1>
  ...
  <div class="glass rounded-xl p-8">
    <form action="{{ route('admin.expenses.store') }}" method="POST" id="expenseForm" class="space-y-6">
      @csrf
      ...
      <div>
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Expense Lines</h3>
      ...
      <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <a href="{{ route('admin.expenses.index') }}" class="px-6 py-2.5 rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold transition-all">
          Cancel
        </a>
