...
<div class="space-y-6">
        ...
        <div class="bg-white dark:bg-dark-card rounded-xl p-5 shadow-sm border border-primary-100 dark:border-primary-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-primary-900 dark:text-white mt-1">4</p>
                </div>
        ...
        <div class="bg-white dark:bg-dark-card rounded-xl p-5 shadow-sm border border-primary-100 dark:border-primary-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-primary-900 dark:text-white mt-1">TZS 850M</p>
                </div>
    ...
    <div class="bg-white dark:bg-dark-card rounded-xl shadow-sm border border-primary-100 dark:border-primary-800">
            ...
            <table class="w-full">
                ...
                <tbody>
                    <tr class="border-b border-primary-100 dark:border-primary-800 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors">
                        <td class="px-4 py-3 text-sm font-medium text-primary-900 dark:text-white">Fixed Term Investment</td>
                        <td class="px-4 py-3 text-sm text-primary-700 dark:text-primary-300">Fixed</td>
                        <td class="px-4 py-3 text-sm text-primary-700 dark:text-primary-300">12.5% p.a.</td>
                        <td class="px-4 py-3 text-sm text-primary-700 dark:text-primary-300">TZS 500,000</td>
                        <td class="px-4 py-3 text-sm text-primary-700 dark:text-primary-300">12 months</td>
                        <td class="px-4 py-3">
                    ...
                    <tr class="border-b border-primary-100 dark:border-primary-800 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors">
                        <td class="px-4 py-3 text-sm font-medium text-primary-900 dark:text-white">Flexible Investment</td>
                        <td class="px-4 py-3 text-sm text-primary-700 dark:text-primary-300">Flexible</td>
                        <td class="px-4 py-3 text-sm text-primary-700 dark:text-primary-300">8.0% p.a.</td>
        ...
        <div class="p-4 border-t border-primary-100 dark:border-primary-800 flex items-center justify-between">
            <p class="text-xs text-primary-600 dark:text-primary-400">Showing 1-2 of 6 products</p>
            <div class="flex items-center gap-2">
