...
@section('breadcrumb', 'Accounting \u203A Fixed Assets \u203A Create Fixed Asset')
...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Fixed Asset</h1>
      <p class="text-gray-600 dark:text-gray-400 mt-1">Add a new fixed asset to the system</p>
    </div>
  ...
  <div class="glass rounded-xl p-8">
    <form action="{{ route('admin.fixed-assets.store') }}" method="POST" class="space-y-6">
      @csrf
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="number" name="purchase_cost" step="0.01" min="0" value="{{ old('purchase_cost') }}" required
            class="form-input py-2.5 px-4 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-card text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            placeholder="0.00">
          @error('purchase_cost')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
        ...
        <div>
          ...
          <input type="number" name="salvage_value" step="0.01" min="0" value="{{ old('salvage_value', 0) }}"
            class="form-input py-2.5 px-4 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-card text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            placeholder="0.00">
          @error('salvage_value')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
        ...
        <div>
          ...
          <input type="number" name="useful_life_years" min="1" value="{{ old('useful_life_years') }}" required
            class="form-input py-2.5 px-4 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-card text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            placeholder="e.g., 5">
