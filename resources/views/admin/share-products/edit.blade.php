...
<div class="space-y-6">
  ...
  <div class="glass p-6">
    <form action="{{ route('admin.share-products.update', $shareProduct) }}" method="POST" class="space-y-6">
      @csrf
      @method('PUT')
      ...
      <div>
        ...
        <textarea name="description" rows="4"
                  class="form-input"
                  placeholder="Enter product description">{{ old('description', $shareProduct->description) }}</textarea>
