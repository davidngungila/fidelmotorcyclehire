...
@section('breadcrumb', 'Accounting \u203A Payments \u203A Create Payment')
...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Payment</h1>
      <p class="text-gray-600 dark:text-gray-400 mt-1">Record money paid to vendors, suppliers, and other expenses</p>
    </div>
  ...
  <div class="glass rounded-xl p-8">
    <form action="{{ route('admin.payments.store') }}" method="POST" id="paymentForm" class="space-y-6">
      @csrf
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Payee</label>
      ...
      <div>
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Payment Lines</h3>
      ...
      <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <a href="{{ route('admin.payments.index') }}" class="px-6 py-2.5 rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold transition-all">
          Cancel
        </a>
